...
These apply whether you're dealing with water damage from a burst supply line, smoke and soot after a kitchen fire, or a mold discovery behind bathroom tile.

1. **Verify their license with the Nevada State Contractors Board.** Nevada requires restoration contractors to hold an active license. Go to nvcontractorsboard.com, search the company name, and confirm the license is current and covers the scope of work. Takes two minutes.
